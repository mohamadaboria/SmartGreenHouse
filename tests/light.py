...
class LightSensor:
    ...
    def __init__(self, ads_sensor=None, ads_channels=None, I2C=None):
        ...
        try:
            ...
            # self.__veml_sensor.gain = adafruit_veml7700.VEML7700_GAIN_2
            # self.__veml_sensor.integration_time = adafruit_veml7700.VEML7700_IT_400MS
    ...
    def get_light_intensity_veml(self):
        ...
        try:
            self.__last_veml_lux = self.__veml_sensor.autolux
